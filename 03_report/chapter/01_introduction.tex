...
The goal of this laboratory exercise is to design, simulate, and implement a control system for the Ball-in-Tube setup, where the height of a ping-pong ball is regulated using an upward airflow. This report provides a concise overview of the modeling of the system, linearization, PID controller design, simulation-based evaluation, and final implementation insights. The structure of the report follows the typical modeling–control–results workflow recommended for advanced control engineering experiments.
